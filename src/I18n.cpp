...
const Entry kEnglish[] = {
    ...
    {"忘记这台设备", "Forget this device"},
    {"忘记", "Forget"},
    {"这台设备已经配对过。忘记之后它无法再连接本机，",
     "This device is paired. Forgetting it means it can no longer connect here — "},
    {"要用得两台设备都在手边重新配对一次。",
     "you would have to pair again with both devices in hand."},
    {"已从列表移除 %1", "Removed %1 from the list"},
    {"已忘记 %1，配对关系已解除", "Forgot %1 — the pairing is gone"},
